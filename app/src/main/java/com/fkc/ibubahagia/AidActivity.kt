...
class AidActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.title.text = resources.getString(R.string.menu_item_2)
        ...
        override fun onPageSelected(position: Int) {
            ...
            when (position) {
                ...
                layouts.size - 1 -> {
                    ...
                    text.text = resources.getString(R.string.konten_aid_epilog)
                    text.makeLinks(
                        Pair("Tips mencegah DPM", View.OnClickListener {
                            val intent = Intent(this@AidActivity, TmdActivity::class.java)
                            startActivity(intent)
                            finish()
                        }),
                        Pair("Bantuan", View.OnClickListener {
                            val intent = Intent(this@AidActivity, ContactActivity::class.java)
                            startActivity(intent)
                            finish()
                        })
                    )
